...
class Customer(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True)
    # Relación con el usuario (por ejemplo, el dueño o creador del cliente)
    user_id = db.Column(db.Integer, db.ForeignKey('users.id'), nullable=False)
    ...
    # Relación: un cliente puede tener muchas facturas asociadas.
    # Para que esta relación funcione, en tu modelo Invoice deberás agregar:
    #   customer_id = db.Column(db.Integer, db.ForeignKey('customers.id'), nullable=True)
    invoices = db.relationship("Invoice", backref="customer", lazy=True)
    
    # Relación: el usuario que posee o creó este cliente.
